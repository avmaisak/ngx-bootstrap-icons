export const BoxArrowBottomRight = `<svg class="bi bi-box-arrow-bottom-right" width="1em" height="1em" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
