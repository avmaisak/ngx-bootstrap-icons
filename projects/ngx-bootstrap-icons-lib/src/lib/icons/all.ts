...
import { AlertCircleFill } from './alert-circle-fill';
import { AlertCircle } from './alert-circle';
import { AlertOctagonFill } from './alert-octagon-fill';
import { AlertOctagon } from './alert-octagon';
import { AlertSquareFill } from './alert-square-fill';
import { AlertSquare } from './alert-square';
import { AlertTriangleFill } from './alert-triangle-fill';
import { AlertTriangle } from './alert-triangle';
import { ArchiveFill } from './archive-fill';
import { Archive } from './archive';
import { ArrowBarBottom } from './arrow-bar-bottom';
...
import { BoxArrowBottomLeft } from './box-arrow-bottom-left';
import { BoxArrowBottomRight } from './box-arrow-bottom-right';
